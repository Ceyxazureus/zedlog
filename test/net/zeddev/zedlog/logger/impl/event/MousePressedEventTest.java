...
/**
 * Unit test for {@link net.zeddev.zedlog.logger.impl.event.MousePressedEvent}.
 * 
 * @author Zachary Scott <zscott.dev@gmail.com>
 */
public class MousePressedEventTest {
	
	/** Tests the {@code MousePressedEvent} creation/instantiation. */
	@Test
	public void testMousePressedEvent() throws Throwable {
		
		MousePressedEvent inst = new MousePressedEvent(
	...
	@Test
	public void testMousePressedEventXML() throws Throwable {
		
		LogEvent inst = new MousePressedEvent(
			new NativeMouseEvent(1, 2, 3, 4, 5, 6)
		);
		...
		// parse xml
		LogEvent readEvent = new MousePressedEvent();
