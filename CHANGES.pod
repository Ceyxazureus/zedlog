...
=head2 v0.2beta4 - Released 21-August-2013

=over 4

=item * Changed to use a portable XML log format.

=item * Minor refactoring of codebase and addition of unit testing for logger
components.

=item * Added installer framework.

=back

=head2 v0.2beta3 - Released 14-July-2013 
